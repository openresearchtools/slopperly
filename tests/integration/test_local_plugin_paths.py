...
class LocalPluginPathTests(unittest.TestCase):
    ...
    def test_omnigen_uses_comfy_multi_image_plugin_path(self):
        ...
        self.assertIn("image_1", prompt["4"]["inputs"]["prompt"])
        self.assertIn("image_2", prompt["4"]["inputs"]["prompt"])
        self.assertNotIn("<img><|image_1|></img>", prompt["4"]["inputs"]["prompt"])
        self.assertNotIn("<img><|image_2|></img>", prompt["4"]["inputs"]["prompt"])
