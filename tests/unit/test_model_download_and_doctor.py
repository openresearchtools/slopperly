...
class ModelDownloadAndDoctorTests(unittest.TestCase):
    ...
    def test_download_dry_run_plans_files_and_snapshots(self):
        ...
        self.assertIn(("wan22_i2v_a14b_720p16_to24_gguf", "PLAN"), statuses)
        self.assertIn(("wan22_i2v_a14b_720p16_to24_gguf:wan22_i2v_lightx2v_high_lora", "PLAN"), statuses)
        self.assertIn(("wan22_i2v_a14b_720p16_to24_gguf:wan22_i2v_lightx2v_low_lora", "PLAN"), statuses)
