...
- **DIRECT TORCH/DIFFUSERS VIDEO GAP:** `video/ltx23_lipsync.py`, `video/ltx23_multi.py`, `video/ltx23_multi_ic_lora.py`, `video/skyreels.py`, `video/wan_t2v.py`, and `video/wan_i2v.py` still contain direct Torch/Diffusers/Transformers generation paths. These are not migrated to the required Comfy gateway.
...
- Not done - next action required: port and artifact-certify LTX 1080p, `video/ltx23_lipsync.py`, `video/ltx23_multi.py`, and `video/ltx23_multi_ic_lora.py` through owned ComfyUI before claiming those LTX workflows complete. Original Wan A14B `video/wan_t2v.py` and `video/wan_i2v.py` also remain direct Torch/Diffusers and require their own GGUF Comfy ports.
