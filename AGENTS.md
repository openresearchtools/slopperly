...
- Evidence: `python -m slopperly.audit.dropdown_certification --profile smoke_16gb --report-only` now reports `PASS lumina2_t2i`, 40 passed entries, and 4 blocked entries.
