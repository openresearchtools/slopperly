...
Local ComfyUI workflow for `Tongyi-MAI/Z-Image` text-to-image generation using the official Comfy-Org Z-Image template shape.

## Required Nodes

- ComfyUI core nodes from commit `603d891eaf045d726d9c23276b4428daf2977624`: `UNETLoader`, `ModelSamplingAuraFlow`, `CLIPLoader`, `VAELoader`, `CLIPTextEncode`, `EmptySD3LatentImage`, `KSampler`, `VAEDecode`, and `SaveImage`.
