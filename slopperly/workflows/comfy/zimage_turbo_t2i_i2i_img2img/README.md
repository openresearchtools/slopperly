...
Local ComfyUI workflow for `Tongyi-MAI/Z-Image-Turbo` image-to-image generation using the official Comfy-Org Z-Image Turbo text/sampling path plus local image encoding.

## Required Nodes

- ComfyUI core nodes from commit `603d891eaf045d726d9c23276b4428daf2977624`: `UNETLoader`, `ModelSamplingAuraFlow`, `CLIPLoader`, `VAELoader`, `CLIPTextEncode`, `ConditioningZeroOut`, `LoadImage`, `ImageScale`, `VAEEncode`, `KSampler`, `VAEDecode`, and `SaveImage`.
